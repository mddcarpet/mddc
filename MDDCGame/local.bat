...
-DEFGAMEINI=..\..\%gamename%Game\Config\DefaultGame.ini ^
-GAMEINI=..\..\%gamename%Game\Config\Game.ini ^
-DEFINPUTINI=..\..\%gamename%Game\Config\DefaultInput.ini ^
-INPUTINI=..\..\%gamename%Game\Config\Input.ini